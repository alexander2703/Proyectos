        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body"> 
                            <form action="index.php?c=AlumnoController&a=actualizar" method="POST" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="form-group row justify-content-center">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="txtCarrera" value="<?php echo isset($_REQUEST['txtCarrera']) ? $_REQUEST['txtCarrera'] : $data["consulta"]["carrera"]; ?>">
                                ...
                                <div class="form-group row justify-content-center">
                                    <label for="inputPassword" class="col-sm-2 col-form-label">Facultad:</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="txtFacultad" value="<?php echo isset($_REQUEST['txtFacultad']) ? $_REQUEST['txtFacultad'] : $data["consulta"]["facultad"]; ?>">
